...
const NoteState = (props) => {
  const host = "https://stickystream-backend.onrender.com";
...
const AddNotefun = async (title, description, getAllnotes) => {
  try {
    ...
    const url = 'https://stickystream-backend.onrender.com/api/notes/addnotes'; // Replace with your actual backend URL
